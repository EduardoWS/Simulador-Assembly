...
main:
	...
	Loop:
		...
		LoopTiros:
			...
			loadn r1, #vetTiros   ;ponteiro para a posição vetTiros[0]
			inc r1                ;i++ pois queremos conferir a posição i=1 ja que a i=0 obviamente tera um tiro
			loadi r2, r1          ;coloca no r2 o que tem em vetTiros[1]
			loadn r3, #1200
			cmp r3, r2			  ;compara vetTiros[1] com 1200
			jne funcao_loop       ;se for diferente vai entrar novamente no looptiros para movimentar o outro tiro
			inc r1
			loadi r2, r1
			cmp r3, r2			  ;compara vetTiros[2] com 1200
			jne funcao_loop
			...
			saidinha:
				;função sem nada so para sair do loop

...
ApagaTela:
	...
	rts	
;********************************************************
;               PEGA UMA TECLA INPUTADA
;********************************************************
InputTecla:	   ;Espera que uma tecla seja digitada e salva na variavel global "Tecla"
...
;                       COMPARA
;********************************************************	
Compara:	   ;Rotina que compara a letra digitada para ver se ela pertence a palavra
	push fr	;Protege o registrador de flags
   ...
   Compara_Fim:
	...
	; Se NAO, incrementa o ERRO
	load r7, Erro	; Se nao acertou, incrementa o contador de Erro!
	inc r7			; Erro++
	store Erro, r7 ;atualiza o num de erros
...
TestaFim:	; Rotina que testa se o jogo terminou 
   ...
   loadn r3, #'s'
	load r4, Tecla
	cmp r3, r4		;tecla == 's'?
	jne TestaFim_JogarNovamente ;volta pro menu
...
TestaFim_Perdeu:
   ...
   loadn r0, #988
	load r1, Palavra ;printa a palavra escolhida da rodada
	loadn r2, #512
	call ImprimeStr
...
PrintaTentativa:
	...
	PrintaTentativa1:	;r0 =numero da linha que vai iniciar
		

		loadn r0, #222 ;posicao da tela onde é impresso
	...
	PrintaTentativa2:	;r0 =numero da linha que vai iniciar
	...
	PrintaTentativa3:	;r0 =numero da linha que vai iniciar
	...
	PrintaTentativa4:	;r0 =numero da linha que vai iniciar
	...
	PrintaTentativa5:	;r0 =numero da linha que vai iniciar
	...
	PrintaTentativa6:	;r0 =numero da linha que vai iniciar
	...
	PrintaTentativa7:	;r0 =numero da linha que vai iniciar
	...
	PrintaTentativa8:	;r0 =numero da linha que vai iniciar
